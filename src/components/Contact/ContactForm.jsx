const ContactForm = () => {
  return (
    <section className="relative overflow-clip bg-gradient-to-t from-[#10343E] to-[#7695BD] sm:px-10 px-4 py-4 sm:w-[37rem] rounded-xl drop-shadow-lg">
      <div>
      ...
      <form>
        ...
        <textarea
          ...
          placeholder="Message"
        ></textarea>
        <button className="bg-[#5C30FD] text-white sm:text-xl text-lg font-medium py-4 sm:px-10 px-6 rounded-3xl">
          Send Message
        </button>
      </form>
